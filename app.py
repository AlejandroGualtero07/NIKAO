...
# Ruta para servir favicon.ico y favicon.png directamente desde la raíz
@app.route('/favicon.ico')
def favicon_ico():
    return app.send_static_file('images/logo_nuevo_nikao.ico')

@app.route('/favicon.png')
def favicon_png():
    return app.send_static_file('images/LOGO_NUEVO_NIKAO.png')
